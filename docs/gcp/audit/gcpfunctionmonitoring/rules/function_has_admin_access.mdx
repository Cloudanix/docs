...
1. Open the GCP Cloud Console and navigate to the Cloud Functions section.

2. Identify the Cloud Function that has admin access.

3. Open the Cloud Function and click on the "Edit" button.

4. Scroll down to the "Cloud IAM" section and click on the "Add" button.

5. In the "Add members" field, enter the email address of the user or service account that needs access to the function.

6. In the "Role" field, select the appropriate role for the user or service account. The role should not have admin access, but should provide the necessary permissions for the user or service account to perform its intended function.

7. Click on the "Save" button to apply the changes.

8. Once the changes are saved, verify that the user or service account has the appropriate access level by testing the function.

By following the above steps, you can remediate the misconfiguration of a GCP Cloud Function having admin access and ensure that the function has the appropriate access level to perform its intended function.
