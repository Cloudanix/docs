...
- The google.iam.admin.v1.CreateServiceAccountKey event in GCP for IAM refers to the creation of a new service account key in the Google Cloud Identity and Access Management (IAM) service.
