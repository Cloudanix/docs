...
title: google.iam.admin.v1.DeleteServiceAccount
sidebar_label: google.iam.admin.v1.DeleteServiceAccount
---
                       
### Event Information

- The google.iam.admin.v1.DeleteServiceAccount event in GCP for IAM refers to the deletion of a service account in Google Cloud Identity and Access Management (IAM).
