...
- The resourcemanager.folders.setIamPolicy event in GCP for IAM refers to a change in the IAM (Identity and Access Management) policy for a folder in Google Cloud Platform (GCP).
