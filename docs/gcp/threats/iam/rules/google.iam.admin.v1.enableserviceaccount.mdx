...
- The google.iam.admin.v1.EnableServiceAccount event in GCP for IAM refers to the action of enabling a service account in the Google Cloud Identity and Access Management (IAM) system.
