...
2. Navigate to the Bigtable Instance Admin page: From the GCP Console dashboard, click on the "Navigation Menu" (☰) in the top-left corner and select "Bigtable" under the "Storage" section. Then, click on "Instance Admin" in the left-hand menu.
