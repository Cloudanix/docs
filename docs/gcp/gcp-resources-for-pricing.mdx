...
| ------------------ | ------------ | ----------------------------- |
| GCP Compute Engine | Per instance | Count of instances            |
| GCP CloudSql       | Per instance | Count of instances            |
| GCP BigTable       | Per instance | Count of instances            |
| GCP Storage        | Per bucket   | Count of buckets              |
| GCP KMS            | Per instance | Count of keys                 |
