---
slug: azure_minimize_wildcard_use_cluster_roles
title: Minimize Wildcard Use Roles And Clusterroles
sidebar_label: Minimize Wildcard Use Roles And Clusterroles
---
