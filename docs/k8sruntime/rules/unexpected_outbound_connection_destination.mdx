--- 
slug: Unexpected outbound connection destination
rule: Unexpected outbound connection destination
title: Unexpected outbound connection destination
sidebar_label: Unexpected outbound connection destination
---
