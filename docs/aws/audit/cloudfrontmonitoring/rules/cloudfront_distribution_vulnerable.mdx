---
slug: cloudfront_distribution_vulnerable
title: Cloudfront Distribution Vulnerable To Takeover
sidebar_label: Cloudfront Distribution Vulnerable To Takeover
---

### More Info:

Cloudfront associated S3 bucket domain vulnerable to takeover
