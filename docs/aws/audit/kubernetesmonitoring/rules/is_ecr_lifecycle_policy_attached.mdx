...
3. Click on the name of the repository that you want to check. This will open the repository details page.

4. In the repository details page, select the "Lifecycle policies" tab. If there are no lifecycle policies listed, then the ECR image repository does not have a lifecycle policy attached.
