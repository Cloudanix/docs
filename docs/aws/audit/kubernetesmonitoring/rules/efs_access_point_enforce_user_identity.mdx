---
slug: efs_access_point_enforce_user_identity
title: EFS Access Points User Identity Should Be Enforced
sidebar_label: EFS Access Points User Identity Should Be Enforced
---
