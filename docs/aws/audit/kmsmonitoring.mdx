...
- [Existence of specific AWS KMS CMKs](kmsmonitoring/rules/kms_specific_cmk)
...
- [Secrets Manager Secrets Should Be Encrypted With CMKs](kmsmonitoring/rules/secret_encrypted_kms_cmk)
- [Secrets Manager Secrets Rotation Enabled](kmsmonitoring/rules/secret_rotation)
- [Secrets Manager Secrets Rotation Enabled](kmsmonitoring/rules/secret_rotation_interval)
- [Secrets Manager Should Be In Use](kmsmonitoring/rules/secrets_manager_in_use)
