...
- [Secret Manager Secrets Should Be Encrypted With CMKs](kmsmonitoring/rules/secret_encrypted_kms_cmk) 
- [Secret Manager Secrets Rotation Enabled](kmsmonitoring/rules/secret_rotation) 
- [Secrets Manager Secrets Should Be Rotated Frequently](kmsmonitoring/rules/secret_rotation_interval) 
