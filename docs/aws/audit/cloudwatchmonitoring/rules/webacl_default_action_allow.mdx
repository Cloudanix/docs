---
slug: webacl_default_action_allow
title: Default WebACL Action Without Rules Should Be Allowed
sidebar_label: Default WebACL Action Without Rules Should Be Allowed
---
