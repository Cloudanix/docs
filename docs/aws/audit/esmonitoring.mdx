...
- [Elastic Cache Encrypted at Rest and in Transit](esmonitoring/rules/elastic_cache_encrypted_at_rest_and_transit)
- [Elastic Cache Encrypted at Rest and in Transit](esmonitoring/rules/elastic_cache_encrypted_at_rest_and_transit)
- [Elasticache RBAC Authentication Enabled](esmonitoring/rules/elasticache_rbac_auth_enabled)
- [Elasticache Clusters Automatic Backup Enabled](esmonitoring/rules/elasticache_redis_cluster_automatic_backup)
- [Elasticache Automatic Failover Enabled](esmonitoring/rules/elasticache_repl_grp_auto_failover_enabled)
- [Auth Enabled for ElastiCache Replication Groups](esmonitoring/rules/elasticache_repl_grp_redis_auth_enabled)
...
- [ElasticSearch Domains Should Use The Latest Service Software](esmonitoring/rules/es_latest_service_software)
