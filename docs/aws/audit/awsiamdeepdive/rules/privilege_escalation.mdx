...
`canEscalatePrivileges` — Indicates that the IAM user or role has permissions that could be leveraged to escalate privileges and gain higher access than intended.
...
A principal is flagged if it has **any** of the following permission combinations:
