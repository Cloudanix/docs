...
1. Identify the expiring reserved instances:
   ...
   - In the Reserved Instances dashboard, review the list of reserved instances and identify the ones that are expiring within the next 30 days.
     (In the Cloudanix Console, navigate to "Misconfig" page and look for Affected Assets for "Reserved Instance Lease Expiration In The Next 30 Days" Policy.)
