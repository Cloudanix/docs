...
title: RDS Recovery Point Should Be Created
sidebar_label: RDS Recovery Point Should Be Created
---

### More Info:

This rule checksif a recovery point was created for Amazon Relational Database Service (Amazon RDS). The rule is NON_COMPLIANT if the Amazon RDS instance does not have a corresponding recovery point created within the specified time period.
